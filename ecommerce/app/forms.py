...
class MyPasswordChangeForm(PasswordChangeForm):
    old_password = forms.CharField(
        label='Old Password',
        widget=forms.PasswordInput(attrs={'autofocus':'True','auto-complete':'current-password', 'class': 'form-control', 'placeholder': 'Enter old password'})
    )
...
class CustomerProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'state': forms.Select(attrs={'class': 'form-control'}),  # Assuming you have a STATE_CHOICES tuple
